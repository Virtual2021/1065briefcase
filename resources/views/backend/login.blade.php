 ...
 <div class="content-area">
        <div class="login-box">
          <div class="login-inner">
            ...
            <p class="py-30">Welcome back, please sign in below.</p>
             @include('includes.backend.form-login')
            <form class="login" id="loginform" method="post" action = "{{route('backend.login.submit')}}" enctype="multipart/form-data">
               {{csrf_field()}}
              <div class="flex-container">
                ...
                <div class="twelve-columns">
                  <div class="form-input">
                    <input type="password" name="password" id="" class="form-input" placeholder="Password" required>
                    <i class="fas fa-key"></i>
                  </div>
                </div>

                <div class="twelve-columns forgot-pass">
                  <a href="{{ route('backend.forgot') }}">
                    Forgot Password?
                  </a>
                </div>
