 ...
 <div class="content-area">
        <div class="login-box">
          <div class="login-inner">
            ...
            <p class="py-30"><h4 class="title">{{ __('Reset Password') }}</h4></p>
             @include('includes.backend.form-both')
            <form class="login" id="forgotform" method="post" action = "{{route('backend.resetpass.submit')}}" enctype="multipart/form-data">
               {{csrf_field()}}
